...
async def random_write_read_test(dut):
    ...
    dut.imm_source = source
    assert dut.immediate.value == "111111111111111111111111111010110"
    #python interprets int as unit. sub 1<,32 as int to get corresponding negative value
